                        ...
                        try {
                            ...
                            if (config.LANG == 'SI' || config.LANG == 'EN') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*📵 බොට් වාර්තාව [Maraya] 📵*' + 
                                    ...
                                    '\n_ඔබේ bot සඳහා යම් උදව්වක් අවශ්‍ය නම්, https://chat.whatsapp.com/IgFh0yQPaHU9tv1lrRaqLF_\n\n' +
                                    '*Report:* ```' + error + '```\n\n'
                                    , MessageType.text);
